  ...
  return (
    <DashboardLayout>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
        ...
        {/* HERO */}
        <section className="bg-gradient-to-r from-green-600 to-teal-600 pt-6 pb-14 text-center px-3 md:px-4">
        ...
        {/* MAIN SECTION (REDUCED SIDE MARGINS LIKE OTHER PAGES) */}
        <section className="px-3 md:px-4 py-10 grid lg:grid-cols-2 gap-4 max-w-full">
